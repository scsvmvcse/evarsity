...
$query ="SELECT * FROM mediumofinstruction"; 
                                ...
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-hdr">
                                        ...
                                        <h2>
                                            ...
                                            mediumofinstruction<span class="fw-300"><i></i></span>
                                        ...
                                        <div class="panel-content">
                                            ...
                                            <form action="" method="post">
                                               <?php if($error){?><div class="errorWrap"><strong>ERROR</strong> : <?php echo htmlentities($error); ?> </div><?php } 
                                                    ...
                                                    <label class="form-label" for="example-textarea">mediumofinstruction</label>
