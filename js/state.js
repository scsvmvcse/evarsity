...
var state_codes = ["0", "37", "12", "18", "10", "22", "26", "25", "7", "30", "24", "6", "2", "1", "20", "29",
    "32", "23", "27", "14", "17", "15", "13", "21", "34", "3", "8", "11", "33",
    "36", "16", "9", "5", "19"];
    ...
    $(function () {
        ...
        for (var i = 0; i < handles.length; i++) {
            if (i === 0) {
                ...
                options += '<option state_code="' + state_codes[i] + '" value="' + handles[i] + '">' + handles[i] + '</option>';
            }
        }
        $('#state_from').html(options);
    });
});
function selct_district($val) {
    ...
    if ($val == 'Chhattisgarh') {
        var Chhattisgarh = ["Bastar", "Bijapur", "Bilaspur", "Dantewada", "Dhamtari", "Durg", "Jashpur", "Janjgir-Champa", "Korba", "Koriya", "Kanker", "Kabirdham", "Mahasamund",
    ...
    if ($val == 'Delhi') {
        var delhi = ["Delhi", "New Delhi", "North Delhi", "Noida", "Patparganj", "Sonbarsa", "Tughlakabad"];
        $(function () {
            var options = '';
    ...
    if ($val == 'Goa') {
        var goa = ["Chapora", "Dabolim", "Madgaon", "Marmugao", "Panaji Port", "Panjim", "Pellet Plant Jetty/Shiroda", "Talpona", "Vasco da Gama"];
        $(function () {
            var options = '';
